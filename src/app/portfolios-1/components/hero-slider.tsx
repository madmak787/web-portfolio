			...
			>
				<CarouselContent className="w-screen h-screen">
					<CarouselItem className="p-0">
						<Image src={`/assets/images/money-heist-01.jpg`} alt="" width={1100} height={768} className="w-screen h-full object-cover object-top" />
					</CarouselItem>
					<CarouselItem className="p-0">
						<Image src={`/assets/images/money-heist-02.jpg`} alt="" width={1100} height={768} className="w-screen h-full object-cover object-top" />
					</CarouselItem>
					<CarouselItem className="p-0">
						<Image src={`/assets/images/money-heist-03.jpg`} alt="" width={1100} height={768} className="w-screen h-full object-cover object-top" />
					</CarouselItem>
				</CarouselContent>
			</Carousel>
